  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <Link href="/admin/koty" className="card p-8 hover:border-oaza-green transition-colors">
        ...
        <Link href="/admin/podania" className="card p-8 hover:border-oaza-green transition-colors">
          <div className="text-3xl mb-3">📋</div>
